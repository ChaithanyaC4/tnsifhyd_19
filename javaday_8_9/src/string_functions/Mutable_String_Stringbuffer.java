...
public class Mutable_String_Stringbuffer {
	...
	public static void main(String[] args) {
		...
		s1.insert(5, " chaithanya");//insert method used to insert another string in middle or end or start
		...
		s1.delete(0, 8);//deletion from certain position to certain position in string as in delete namasthe from s1
